...
Releasy::Project.new do
  ...
  executable "lunar_slingshot.rb"
  files "*.rb", "media/**/*.*", "*.ttf"
  exposed_files "README.md"
  add_link "https://github.com/radi0flyr.com", "Check me out on Github!"
  exclude_encoding # Applications that don't use advanced encoding (e.g. Japanese characters) can save build size with this.

  # Create a variety of releases, for all platforms.
  add_build :osx_app do
    url "com.github.radi0flyr"
    wrapper "gosu-mac-wrapper-0.7.47.tar.gz" # Assuming this is where you downloaded this file.
